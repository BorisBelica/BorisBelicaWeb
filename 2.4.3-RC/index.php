...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-176720107-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'UA-176720107-1');
    </script>
    ...
    <meta name="description" content="Pozri si moje projekty, github profil a ďalšie informácie o mne na mojom osobnom webe." />
    <meta name="author" content="Boris Belica" />
    <meta name="keywords" content="junior web developer, boris belica, boris, belica, moje projekty, projekty, github, wordpress, programátor, developer, web, Javascript, PHP, HTML, CSS, junior, aplikácia, C++, freelancer" />
    <meta name="robots" content="index, follow" />
    <link rel="canonical" href="https://boris-belica.sk/" />


    <meta property="og:site_name" content="Boris Belica | Junior FrontEnd Developer" />
    <meta property="og:url" content="https://boris-belica.sk/" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Boris Belica | Junior FrontEnd Developer & Video Creator" />
    <meta property="og:description" content="Pozri si moje projekty, github profil a ďalšie informácie o mne na mojom osobnom webe." />
    <meta property="og:image" content="https://www.boris-belica.sk/img/footer/footer-fhd.JPG" />
    <meta property="og:image" content="http://www.boris-belica.sk/img/footer/footer-fhd.JPG" />


    <meta property='og:title' content='Boris Belica | Junior Web Developer'/>
    <meta property='og:image' content='https://www.boris-belica.sk/img/footer-fhd.JPG'/>
    <meta property='og:description' content='Pozri si moje projekty, github profil a ďalšie informácie o mne na mojom osobnom webe.'/>
    <meta property='og:url' content='https://www.boris-belica.skhttps://www.boris-belica.sk'/>


    <title>Boris Belica | Junior Web Developer</title>
</head>
<!-- HEAD -->
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#FOOTER">
                        <img src="img/etc/copyright.png" alt="copyright logo">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <section id="PROFIL">
            ...
            <div class="five-box">
                <div class="character-box" data-aos="flip-left" data-aos-duration="1000">
                    <img src="img/me-icons/productivity.jpg" alt="logo produktivity" />
                    <h4>Produktívnosť</h4>
                ...
                <div class="character-box" data-aos="flip-left" data-aos-duration="1600">
                    <img src="img/me-icons/focus.jpg" alt="ikona zamerania" />
                    <h4>Sústredenosť</h4>
                ...
                <div class="character-box" data-aos="flip-left" data-aos-duration="1800">
                    <img src="img/me-icons/good.jpg" alt="ikona palca hore" />
            ...
            <div class="two-box">
                <div class="photo-box" data-aos="fade-up" data-aos-duration="1500">
                    <img src="img/me/me-photo.jpg" alt="moja profilová foto" />
                    ...
                    <p>Web developer to je to čo ma momentálne baví. Viem aj čo-to naprogramovať. Mám prehľad o databázach. Rozumiem IT slovníku :-)</p>
                ...
                <div class="tech-box">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">SEO</div>
                    </div>
        ...
        <section id="PROJECTS">
            ...
            <div class="project-box">
                <div class="card" data-aos="flip-left" data-aos-duration="1100">
                    <img src="img/projects/bymijani.jpg" class="card-img-top" alt="foto webu byMijani" />
                    <div class="card-body">
                        <h4>By Mijani</h4>
                        <div class="progress">
                ...
                <div class="card" data-aos="fade-up" data-aos-duration="1100">
                    <img src="img/projects/dvabatohy.jpg" class="card-img-top" alt="fotka webu Dva Batohy" />
                    <div class="card-body">
                        <h4>Dva Batohy</h4>
                ...
                <div class="card" data-aos="flip-right" data-aos-duration="1100">
                    <img src="img/projects/prva-verzia.jpg" class="card-img-top" alt="fotka prvého webu" />
                    <div class="card-body">
                        <h4>Môj web</h4>
...
<!-- GITHUB VIDEO BANNER -->
        <section id="VIDEO-BANNER" class="text-center">
            ...
            <video loop autoplay muted preload="auto">
                <source src="video/video-bg2.mp4" type="video/mp4" />
            </video>
            ...
            <div class="social-box text-center">
                <div>
                    <a href="https://www.facebook.com/Borickoo" target="_blank">
                        <img data-aos="flip-right" data-aos-duration="1000" src="img/social/facebook.jpg" alt="logo facebook" /></a>
                    <a href="mailto:boris.belica2@gmail.com" target="_blank">
                        <img data-aos="flip-right" data-aos-duration="1200" src="img/social/gmail.jpg" alt="logo gmail" /></a>
                </div>

                <div>
                    <a href="https://github.com/BorisBelica" target="_blank">
                        <img data-aos="flip-right" data-aos-duration="1400" src="img/social/github.jpg" alt="logo github" /></a>
                    <a href="https://www.linkedin.com/in/boris-belica-0061631a1" target="_blank">
                        <img data-aos="flip-right" data-aos-duration="1600" src="img/social/linkedin.jpg" alt="logo linkedin" /></a>
                </div>

                <div>
                    <a href="https://www.instagram.com/bor1cko" target="_blank">
                        <img data-aos="flip-left" data-aos-duration="1800" src="img/social/instagram.jpg" alt="logo instagram" /></a>
                    <a href="https://www.youtube.com/user/BoBoO22595" target="_blank">
                        <img data-aos="flip-left" data-aos-duration="2000" src="img/social/youtube.jpg" alt="logo youtube" /></a>
                </div>
            </div>
        </section>
<!-- GITHUB FORM SECTION -->
            ...
            <div class="press-box">
                <div>
                    <a href="https://seredsity.sk/ako-cestovat-sam-seredcania-adela-a-boris-budu-v-nasom-meste-prednasat-o-vyhodnom-a-lacnom-cestovani/" target="_blank">
                        <img data-aos="fade-down" src="img/press/press2.jpg" alt="adel a boris" />
                    </a>
                    ...
                    <a href="https://seredsity.sk/slovinsko-ako-novy-letny-hit-seredcania-adela-a-boris-pre-vas-pripravili-cely-itinerar-a-uzasny-vylet-mozete-zazit-aj-vy/" target="_blank">
                        <img data-aos="fade-down" src="img/press/press1.jpg" alt="adel a boris" />
                    </a>
                </div>

                <div>
                    <a data-aos="fade-down" href="https://seredsity.sk/seredcania-adela-a-boris-navstevovali-cely-rok-jedno-miesto-v-seredi-aby-vytvorili-toto-unikatne-video/" target="_blank"><img src="img/press/press3.jpg" alt="adel a boris" /> </a>

                    <a data-aos="fade-down" href="https://seredsity.sk/pozrite-si-nadherne-video-dvoch-seredcanov-aj-takto-vyzeraju-krasne-slovenske-lesy-ocami-adely-a-borisa/" target="_blank"><img src="img/press/press4.jpg" alt="adel a boris" /> </a>
                </div>
